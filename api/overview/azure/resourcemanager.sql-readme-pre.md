---
title: Azure SQL Management client library for .NET
keywords: Azure, dotnet, SDK, API, Azure.ResourceManager.Sql, sqlmanagement
author: maggiepint
ms.author: magpint
ms.date: 11/06/2021
ms.topic: reference
...
# Azure SQL Management client library for .NET - Version 1.0.0-alpha.20211105.1 
