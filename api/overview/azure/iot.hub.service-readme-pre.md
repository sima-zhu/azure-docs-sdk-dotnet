---
title: Azure IoT Hub client library for .NET
keywords: Azure, dotnet, SDK, API, Azure.IoT.Hub.Service, iot
author: maggiepint
ms.author: magpint
ms.date: 10/06/2021
ms.topic: reference
...
# Azure IoT Hub client library for .NET - Version 1.0.0-alpha.20211005.1 
